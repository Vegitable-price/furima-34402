class ItemsTag
  ...
  def save 
    item = Item.create(name: name, describe: describe, price: price, prefecture_id: prefecture_id, user_id: user_id, ship_fee_id: ship_fee_id, ship_day_id: ship_day_id, status_id: status_id, genre_id: genre_id, images: images)
